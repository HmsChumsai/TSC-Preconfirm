...
function process()
  ...
  orderList,totalList,dealList = TSCReportUtil.getOrderList(orders,1)
...
--  local table_name_total = "DECIDE_total"
  ...
  'paid_received' .. sql_column_text
	...
	{table_name_deal,{'order_no' .. sql_column_integer,
	'deal_seq' .. sql_column_integer,
